...
__global__ void BalancedSigmoidCrossEntropyLossForward(const int n,
                                                       const int dim,
...
template <typename Dtype>
__global__ void BalancedSigmoidCrossEntropyLossBackward(const int n,
                                                        const int dim,
...
template <typename Dtype>
void BalancedSigmoidCrossEntropyLossLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  BalancedSigmoidCrossEntropyLossForward
...
template <typename Dtype>
void BalancedSigmoidCrossEntropyLossLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  if (propagate_down[0]) {
    ...
    BalancedSigmoidCrossEntropyLossBackward
        <<<CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS>>>
...
INSTANTIATE_LAYER_GPU_FUNCS(BalancedSigmoidCrossEntropyLossLayer);
