...
void BalancedSigmoidCrossEntropyLossRefLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void BalancedSigmoidCrossEntropyLossRefLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void BalancedSigmoidCrossEntropyLossRefLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void BalancedSigmoidCrossEntropyLossRefLayer<Dtype>::Backward_cpu(
...
#ifdef CPU_ONLY
STUB_GPU(BalancedSigmoidCrossEntropyLossRefLayer);
#endif

INSTANTIATE_CLASS(BalancedSigmoidCrossEntropyLossRefLayer);
REGISTER_LAYER_CLASS(BalancedSigmoidCrossEntropyLossRef);
