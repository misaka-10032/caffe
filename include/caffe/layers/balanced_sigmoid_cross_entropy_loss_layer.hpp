#ifndef CAFFE_BALANCED_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_BALANCED_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
/**
 * @brief Computes the BALANCED cross-entropy (logistic) loss @f$
...
class BalancedSigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  /// @copydoc BalancedSigmoidCrossEntropyLossLayer
...
#endif  // CAFFE_BALANCED_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_HPP_
