#ifndef CAFFE_MSE_LOSS_LAYER_HPP_
#define CAFFE_MSE_LAYER_HPP_
...
class MseLossLayer : public LossLayer<Dtype> {
 public:
  explicit MseLossLayer(const LayerParameter& param)
...
#endif  // CAFFE_MSE_LOSS_LAYER_HPP_
